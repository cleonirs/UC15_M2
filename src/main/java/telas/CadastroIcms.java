...
public class CadastroIcms extends javax.swing.JFrame {

    public CadastroIcms() {
        initComponents();
    }

    private DefaultTableModel montarTabela(List<Icms> listaIcms) {
        String[] colunas = {"ID", "Aliquota", "Redução", "Valido até"};
        DefaultTableModel tabela = new DefaultTableModel();
        tabela.setColumnIdentifiers(colunas);

        for (int i = 0; listaIcms.size() > i; i++) {
            Icms icms = listaIcms.get(i);

            String[] linha = {
                Integer.toString(icms.getId()),
                icms.getAliquota(),
                icms.getReducao(),
                icms.getBaseLegal()
            };
    ...
    private String getIdItemSelecionado() {
        int posicao = jtableIcms.getSelectedRow();
        if (posicao == -1) {
            JOptionPane.showMessageDialog(null, "Selecione um item da tabela!");
        }
        return (String) jtableIcms.getValueAt(posicao, 0);
    }

    private Icms icmsEdicao = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRO DE ALIQUOTA DE ICMS");

        jLabel2.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
        jLabel2.setText("Aliquota");

        jLabel3.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
        jLabel3.setText("Redução");

        jLabel4.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
        jLabel4.setText("Base Legal");
        ...
        txtReducao.setFont(new java.awt.Font("Arial", 0, 20)); // NOI18N
        txtReducao.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        ...
        txtBaseLegal.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtBaseLegalActionPerformed(evt);
            }
        });

        jtableIcms.setModel(montarTabela(IcmsJPA.listar()));
        jScrollPane1.setViewportView(jtableIcms);
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtReducao)
                            .addComponent(txtBaseLegal, javax.swing.GroupLayout.PREFERRED_SIZE, 344, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(txtReducao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        Icms icms = new Icms();
        icms.setAliquota(txtAliquota.getText());
        icms.setReducao(txtReducao.getText());
        icms.setBaseLegal(txtBaseLegal.getText());

        if (icmsEdicao != null) {
            icmsEdicao.setAliquota(txtAliquota.getText());
            icmsEdicao.setReducao(txtReducao.getText());
            icmsEdicao.setBaseLegal(txtBaseLegal.getText());
            IcmsJPA.atualizar(icmsEdicao);
            JOptionPane.showMessageDialog(null, "ICMS atualizado com sucesso!");

        } else {
            IcmsJPA.cadastrar(icms);
            JOptionPane.showMessageDialog(null, "ICMS cadastrada com sucesso!");
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        IcmsJPA.excluir(Integer.parseInt(getIdItemSelecionado()));
        jtableIcms.setModel(montarTabela(IcmsJPA.listar()));
        jScrollPane1.setViewportView(jtableIcms);
    ...
    private void txtBaseLegalActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBaseLegalActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtBaseLegalActionPerformed

    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        String idSelecionado = getIdItemSelecionado();
        icmsEdicao = IcmsJPA.obter(Integer.parseInt(idSelecionado));
        txtAliquota.setText(icmsEdicao.getAliquota());
        txtReducao.setText(icmsEdicao.getReducao());
        txtBaseLegal.setText(icmsEdicao.getBaseLegal());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroIcms.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroIcms().setVisible(true);
            }
        });
    }
