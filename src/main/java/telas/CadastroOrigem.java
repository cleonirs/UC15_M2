...
public class CadastroOrigem extends javax.swing.JFrame {
    ...
    private DefaultTableModel montarTabela(List<Origem> listaOrigem) {
        String[] colunas = {"ID", "Origem", "Descrição"};
        DefaultTableModel tabela = new DefaultTableModel();
        tabela.setColumnIdentifiers(colunas);

        for (int i = 0; listaOrigem.size() > i; i++) {
            Origem origem = listaOrigem.get(i);

            String[] linha = {
                Integer.toString(origem.getId()),
                origem.getNumero(),
                origem.getDescricao()
            };
            tabela.addRow(linha);
    ...
    private String getIdItemSelecionado() {
        int posicao = jtableOrigem.getSelectedRow();
        if (posicao == -1) {
            JOptionPane.showMessageDialog(null, "Selecione um item da tabela!");
        }
        return (String) jtableOrigem.getValueAt(posicao, 0);
    }

    private Origem origemEdicao = null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CADASTRO DE ORIGEM");
        ...
        jtableOrigem.setModel(montarTabela(OrigemJPA.listar()));
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txtDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 344, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(250, 250, 250)
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        origem.setNumero(txtOrigem.getText());
        origem.setDescricao(txtDescricao.getText());

        if (origemEdicao != null) {
            origemEdicao.setNumero(txtOrigem.getText());
            origemEdicao.setDescricao(txtDescricao.getText());
            OrigemJPA.atualizar(origemEdicao);
            JOptionPane.showMessageDialog(null, "Origem atualizada com sucesso!");

        } else {
            OrigemJPA.cadastrar(origem);
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        OrigemJPA.excluir(Integer.parseInt(getIdItemSelecionado()));
        jtableOrigem.setModel(montarTabela(OrigemJPA.listar()));
        jScrollPane1.setViewportView(jtableOrigem);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        origemEdicao = OrigemJPA.obter(Integer.parseInt(idSelecionado));
        txtOrigem.setText(origemEdicao.getNumero());
        txtDescricao.setText(origemEdicao.getDescricao());
